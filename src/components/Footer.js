...
class Footer extends Component {
    ...
    render() {
        return (
            <FooterContainer>
                <span style={{ marginLeft: '18%', fontSize: '1.125rem'}}>Question? <Link>Call 1-877-743-1335</Link></span>
                <div className="footer-columns">
                    <ul>
                        <li><Link>FAQ</Link></li>
                        <li><Link>Investor Relations</Link></li>
                        <li><Link>Corporate Infomation</Link></li>
                ...
                <br />
                <span style={{ marginLeft: '15%', fontSize: '0.9rem', marginTop: '2rem' }}>
                    Netflix Canada
                </span>
            </FooterContainer>
        )
